...
<body <?php body_class( 'font-sans text-black' ); ?>>
	...
	<header id="masthead" class="header w-full flex justify-between items-center z-50 absolute top-0 inset-x-0 py-3 px-4 lg:py-4 lg:px-6" role="banner" data-menu-open="false" data-header-fixed="false">
		...
		<nav class="nav z-40 flex items-center" role="navigation">
			...
			<div class="menu-wrapper w-full h-screen fixed inset-0 bg-black p-6 text-white opacity-0 pt-20 overflow-auto lg:flex lg:items-center">
				<?php wp_nav_menu( array(
						'theme_location' => 'menu-main',
						'menu_id' => 'primary-menu',
						'menu_class' => 'list-reset flex flex-row flex-wrap lg:flex-no-wrap lg:justify-center w-full m-0 pt-4 pb-16 lg:pb-0 lg:pt-0 max-w-5xl mx-auto',
						'container' => false,
