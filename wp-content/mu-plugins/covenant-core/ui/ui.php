  ...
  ob_start(); if ( ! empty( $opts ) ) : ?>
    <li class="upcoming-event-item <?php echo $add_top ? 'border-t border-b' : 'border-b'; ?> border-grey-md my-0 py-2 lg:py-3">
      <div class="flex justify-between mb-1">
        <p class="upcoming-event-item__date text-primary text-sm font-medium"><?php echo date( 'm/d/Y', strtotime( $opts['start'] ) ); ?></p>
        <p class="upcoming-event-item__time text-primary text-sm font-medium"><?php echo date( 'g:i A', strtotime( $opts['start'] ) ); ?></p>
      </div>
